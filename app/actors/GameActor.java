...
public class GameActor extends AbstractActor {
	...
	public GameActor(ActorRef out) {
		...
		GameController controller = new GameController(out);
		//give each event class a reference to the controller
		for(Map.Entry<String, EventProcessor> entry : eventProcessors.entrySet())
		{
			entry.getValue().setGameController(controller);
		}	
